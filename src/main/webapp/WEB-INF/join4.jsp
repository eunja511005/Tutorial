  ...
  <main>
    ...
    <div class="row g-5 d-flex justify-content-center">
      <div class="col-md-10">
        ...
        <form class="needs-validation" novalidate id="uploadForm" enctype="multipart/form-data">
          <div class="row g-3">
            ...
            <div class="col-12">
              ...
              <div class="invalid-feedback">
                Please enter a valid email address for sign up.
              </div>
            </div>
          ...
          <h4 class="mb-3">Role</h4>
			...
			<div class="row my-3">
			    ...
			    <div class="col-sm-2">
			        ...
			        <label class="form-check-label" for="role2"> FAMILY </label>
			    </div>
			    <div class="col-sm-2">
          ...
          <hr class="my-4">
	        ...
	        <div class="container col-md-6">
	            <div class="mb-5">
	                <label for="Image" class="form-label">Your image Upload with Preview</label>
	                <input class="form-control" type="file" name="file" id="formFile" onchange="preview()" accept="image/jpeg, image/png">
	            </div>
